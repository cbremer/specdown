...
Shipped in this session: web showcase empty state, social unfurl tags, and the
copy kit above. The web app is unchanged as a **viewer** — drop, browse, URL,
GitHub repo, folder (Chromium), and session restore still open documents the
same way.
